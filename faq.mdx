...
### Should I call external API endpoints directly in resolvers or call them outside to Chalk?

We recommend calling API endpoints directly in Chalk resolvers—this makes it easy to
