...
### How do I query for a random sample of instances from a features class?
...
returning the features specified by the output parameter: [`User.id`, `User.name`, `User.age`].
