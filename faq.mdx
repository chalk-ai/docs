...
The second is that if you define a feature named `ts` with a type of `datetime.datetime` in a feature class, then it will
...
For more information on how feature times work, [see here](/docs/time).
