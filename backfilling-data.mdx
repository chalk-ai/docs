...
description: Chalk makes it easy to batch ingest historical feature data from datasets and bulk data sources.
published: true
...
Run an offline query to obtain a [Dataset](/docs/datasets) of the feature values you want
to ingest and then call [`.ingest`](/api-docs#DatasetRevision.ingest) to store online or offline:
