...
Chalk expressions are used to derive features from operations on other features. In feature definitions, `_`
...
Expressions are useful because Chalk statically analyzes and optimizes them, leading to better performance
...
combination with expression references to transform features:
