...
You can generate this file by running [`chalk init`](/cli/init). The `chalk.yaml` file allows you to configure your
project's [Docker environment](/docs/docker) as well as your [feature validations](/docs/validation).
