...
because [Chalk lets you refer to "single copy" data sources by either their type or their name](/fraud-3#online-data).
...
### Avoid dataclass feature types, instead use separate features sets or unpack the data
...
While python resolvers can be used to read data from your data sources, SQL resolvers are preferred.
