...
The building blocks of Chalk are [features](/docs/features) and resolvers. Features specify what
you want your data to look like.
...
<TipInfo>
  ...
  are all features. The `User` class is a **feature class** (also sometimes referred to as a **feature set**). Specific instances
