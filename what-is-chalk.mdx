...
With Chalk, data scientists easily integrate new data sources, test new features with [point-in-time correctness](docs/temporal-consistency), and collaborate with Git-like branches and flexible data exports (to data catalogs like Parquet and Iceberg).
