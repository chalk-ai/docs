...
metaDescription: 'Chalk is the real-time data platform for ML & GenAI. More than a feature store, Chalk delivers fresh features in under 10ms with on-demand compute and caching in your cloud.'
titleHidden: true
hideToc: true
published: true
---
