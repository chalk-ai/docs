...
By default, Chalk operates as a SaaS offering,
where Chalk executes pipelines and stores data on
its cloud infrastructure.
However, Chalk can also deploy its software into your
AWS or GCP project.
In this model, environments are provisioned via [Terraform](https://terraform.io)
and managed by the Chalk team.
