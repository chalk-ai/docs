...
Chalk is traditionally deployed as a Platform As a Service into an isolated account under the managent of the customer,
with the core components (Kubernetes Cluster, Message Queues, etc) managed by Chalk.
