...
## What aggregations can I materialize?

Chalk materialized windowed aggregations support several types of aggregations. These aggregations will skip any `None`
values. The following table lists the supported aggregations along with some notes.
