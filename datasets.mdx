...
3. Select the checkboxes next to all revisions you want to archive
4. An **Archive** button will appear in the actions bar at the top of the page. Click this button and confirm the action in the dialog.
