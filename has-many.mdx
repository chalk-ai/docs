...
With the joining feature class, you can query for movie features from the actor namespace. For example, if you wanted to
get the titles of the movies an actor appears in, you could run the following query:
