...
<TipInfo>Here, you need to use quotes around <code>User</code> to use a forward reference.</TipInfo>
...
<TipInfo>
  Here you need to use quotes around <code>DataFrame[MovieRole]</code> to use a forward reference.
</TipInfo>
