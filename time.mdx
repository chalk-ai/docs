...
[Chalk Expressions](/docs/expression), you can reference the query time with `_.chalk_now`.
...
You can also reference `_.chalk_now` in [Chalk Expressions](/docs/expression), particularly in
[windowed aggregations](/docs/aggregations):
