...
You may find it more convenient to access query time when it is correlated with the rows of your DataFrame. To have
Chalk include query time as a column in your DataFrame, use [`output_ts`](/api-docs#ChalkClient.sample.output_ts).
