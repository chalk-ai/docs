...
We provide specific setup instructions for [Deepnote](/docs/notebook-setup#deepnote), [Hex](/docs/notebook-setup#hex) and [Vertex](/docs/notebook-setup#vertex-and-google-collab-enterprise), but the process should be similar for other notebook environments.
...
CHALK_CLIENT_SECRET = os.environ.get("CHALK_CLIENT_ID")
...
can be found on our [expressions page](/docs/expression#additional-functions).
