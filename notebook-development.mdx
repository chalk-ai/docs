...
We walk through how to do this for [Deepnote](/docs/notebook-development#deepnote) and [Hex](/docs/notebook-development#hex), but the process should be similar
for other notebooks.
...
You can connect Chalk to any Jupyter notebook environment. In this section, we provide a walkthrough
for running Chalk either locally, with Deepnote, or with Hex. That said, the process should be similar
for other notebooks.
...
This will load your Chalk features into your notebook. For instance, I've your team has defined and deployed
the following features to Chalk, they should now be accessible in your notebook:
...
You can test this by running the following in a notebook cell:
...
To add new features, you'll want to define them onto the features you've loaded into the Notebook.
For instance, say we want to add an `is_large` feature to our Transaction feature class. You can
do so by running the following command:

```python notebook.ipynb
Transaction.is_large = Transaction.amount > 100
```
