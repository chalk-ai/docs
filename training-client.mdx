...
So, if for instance, you requested the `num_transactions` feature for users with id's
of `1`, `2`, or `3`, you could receive multiple rows for each user if you'd calculated
