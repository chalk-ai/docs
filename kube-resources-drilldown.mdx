...
- `streaming` statefulset: A stateful set that runs your [streaming](/docs/streaming) deployments. These are long-running processes that consume from a message queue and write to the online and offline store.
