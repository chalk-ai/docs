...
You can query ClickHouse and other data sources using [standard SQL syntax](/docs/sql).
Connect to a `ClickhouseSource` and query user names with a Python resolver, as shown in the example below:
