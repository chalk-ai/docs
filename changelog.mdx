...
### Chalk's log explorer



### Chalk developer experience improvements

- Improved our support for querying features with has-many relationships in the Chalk dashboard's Data Explorer.
- Added support for aggregating over Vector types (sum, mean)
