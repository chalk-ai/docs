...
We shipped underscore static planning, which enables you to define feature resolution using underscore notation
...
We added integrations for Trino and Spanner as new datasources. We've also added native drivers for Postgres and
