...
The Chalk query plan viewer now highlights nodes for [Chalk expressions](https://docs.chalk.ai/docs/expression) and [SQL resolvers](https://docs.chalk.ai/docs/sql-resolvers) using Chalk's C++ driver in orange.
