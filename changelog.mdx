...
You can now add tags to your deployments. Tags are unique on your environments. If you add an already existing tag
to a new deployment, Chalk will remove the tag from the old deployment.

Tags can be with the `--deployment-tag` flag n the chalk CLI.
