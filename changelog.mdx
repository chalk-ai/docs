...
### Datasets, results returned from Offline Queries, can now be persisted to your AWS Glue catalog
...
These [Chalk Datasets](https://docs.chalk.ai/docs/datasets) can now be exported back into your AWS Glue catalog. This lets other teams discover them and enables downstream analytical workflows.
