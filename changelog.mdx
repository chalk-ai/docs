...
### Dashboard now shows metrics for query runs

When looking at a query run in the dashboard, you'll now find a new Metrics tab showing query metadata, CPU utilization,
...
the offline store. Please reach out if you'd like to try this feature.
