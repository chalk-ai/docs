...
Customers running the gRPC server can now run SQL queries on [dataset](https://docs.chalk.ai/docs/datasets) 
outputs in the dashboard. To use this feature, navigate to the `Datasets` page in the menu, select a dataset,
