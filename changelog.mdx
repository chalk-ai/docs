...
Chalk can automatically create embeddings for [vector feature types](https://docs.chalk.ai/docs/feature-types#vectors) through Open AI.
...
[Easily sample historical state](https://docs.chalk.ai/docs/temporal-consistency) like all the transactions for 3 users from a particular date or include the current time when calling out to a microservice.
...
Chalk checks your features for errors locally before [deploying them to a remote branch.](https://docs.chalk.ai/docs/branches)
