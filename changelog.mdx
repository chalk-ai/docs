...
With KEDA, Chalk environments can now dynamically scale up and down-- even to *zero machines* during periods of reduced or no workload. This scaling enables optimized resource usage. We’re looking forward to seeing how this enhances efficiency across your environments!
...
Read more about how to view [logs using the Chalk CLI in our docs.](https://docs.chalk.ai/cli/logs)
