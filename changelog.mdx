...
### Datasets can now be persisted to your AWS Glue Catalog
...
These [Datasets](https://docs.chalk.ai/docs/datasets), results returned from offline queries, can now be exported back into your AWS Glue catalog.
This lets other teams discover them and enables downstream analytical workflows.
