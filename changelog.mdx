...
Improved the Kubernetes Node UI to display additional data about the nodes in your cluster and polished the UI for compactness and readability.
...
### Query planner viewer now supports
