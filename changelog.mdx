...
[Chalk expressions](/docs/underscore). You can now use [`jaro_winkler_distance`](/api-docs#jaro_winkler_distance)
...
The `chalk.functions` library now supports more array functions that can be used in [underscore expressions](/docs/underscore).
...
You can now reference dataclass struct fields with [underscore expressions](/docs/underscore).
