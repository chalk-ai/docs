...
class Transaction:
    ...
    transaction_enrichment_label: str = F.sagemaker_predict(
    ...
    is_rent: bool = F.like(_.transaction_enrichment_label, "%rent%")
    is_purchase: bool = F.like(_.transaction_enrichment_label, "%purchase%")
