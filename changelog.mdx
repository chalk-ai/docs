...
You can verify if your resolvers are optimized by checking query execution logs or the query plan page—optimized resolvers are highlighted in yellow and marked as "accelerated".
...
Added a new "All Charts" tab under "Metric Charts" section of your Settings that displays all charts available in Chalk.
The new tab shows:
- A complete list of all charts in your environment
- Chart types and categories
- What entities or features each chart is attached to e.g. a link to view the chart
...
[expression documentation](/docs/expression#additional-functions).
