...
- Improved the performance of Chalk branch deployment times
- Added support for aggregations over Vector types (sum, mean)
- Usage data on the number of requests made to your pods can be exported from the Chalk Dashboard as a CSV
