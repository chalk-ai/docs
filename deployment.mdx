...
Once a Chalk Data Plane has been deployed, VPC peering is commonly added to allow private traffic between data sources in other accounts and the Data Plane. Additionally, some offline stores require additional integration steps and permissioning. Adding additional data sources [is fully self-serve](/docs/integrations).
