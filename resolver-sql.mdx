...
using a comment, like so: `-- source: pg_user`.
...
A SQL resolver does not need to output all features in a feature set. You
can specify as many as you want. However, the names of your output columns
must match the names of your features.
