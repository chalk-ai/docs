...
Connect your [Alert Thresholds](/docs/metricmonitor#add-alert-trigger) to external alerting tools like [PagerDuty](/docs/pagerduty), [Slack](/docs/slack), and [IncidentIo](/docs/incidentio).
