...
---
  ...
  You'll need to grant the following IAM permissions. Note that many of these are
  base permissions you may have already configured. The key addition is Glue
