...
<TipInfo>
  Before reading this section, we recommend looking over <a href="/docs/feature-types#vectors">vector
  features</a> and <a href="/docs/embeddings">embedding functions</a>.
</TipInfo>


To illustrate how to use nearest neighbor relationships, we'll walk through an example of how Chalk can power FAQ search.
In this example, the `SearchQuery` feature set represents an incoming search request, and the `FAQDocument`
