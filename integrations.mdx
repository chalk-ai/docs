...
* **[GCP](/docs/gcp)** -
Integrate with Google CLoud Platform to read from data sources such as **[BigQuery](/docs/bigquery)**, **[Spanner](/docs/spanner)**,
**[PubSub](/docs/stream-sources)**, and **[Cloud Storage](/docs/s3)**.
