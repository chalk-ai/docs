...
- Azure Cloud [(Microsoft)](/docs/azure-cloud-deployment)

---

## SQL data sources and data warehouses

Chalk has native drivers and integrations with a variety of [SQL data sources](/docs/sql) and query engines, and
...
- [Microsoft SQL Server (MSSQL) / Azure SQL Database](/docs/mssql)
...
We provide [stream resolvers](/docs/stream-sources) for integrating Kafka compatible systems data sources.
...
Chalk makes it easy to [cache features for low-latency](/docs/feature-caching) access with the `max_staleness` keyword
...
[Chalk's Symbolic Python Interpreter](/docs/static-resolver-optimization) supports accelerating libraries like requests,
