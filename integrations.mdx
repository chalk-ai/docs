...
Chalk integrates seamlessly with your underlying systems--querying your data sources directly and eliminating the need for ETL!
...
Anywhere that you can run Kubernetes, Chalk can also run.
