...
[namespace](/docs/features#namespacing), group (see
[`group_by_windowed`](/docs/aggregations#grouping-windowed-features)), and agg (value to aggregate) represents a unique
