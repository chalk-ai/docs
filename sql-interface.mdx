...
Chalk's SQL interface is based off of the [DuckDB SQL dialect](https://duckdb.org/docs/stable/sql/dialect/overview), and
all queries made will go through a parser that expects a very similar syntax.
