...
In addition, you can set Environment Variable Overrides. One common example of an Environment Variable Override
is `AUTO_SHUTDOWN_PERIOD`, which you can set to the amount of seconds of inactivity after which you'd like the
branch server to spin down.

If you have any questions about how to best configure your environment for your use case, reach out to the Chalk team.
