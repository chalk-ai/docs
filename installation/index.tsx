  ...
  },
  {
    ...
    body: () => (
      <p>
        ...
        <code>
          <a href={'/cli/login'}>chalk login</a>
        </code>{' '}
  ...
  // },
  {
    ...
    body: () => (
      <p>
        ...
        resolvers, use the{' '}
        <code>
          <a href={'/cli/login'}>chalk apply</a>
        </code>{' '}
  ...
  },
  {
    ...
    body: () => (
      <p>
        ...
        <code>
          <a href={'/cli/login'}>chalk query</a>
        </code>{' '}
    ...
    <InstallationLayout>
      ...
      >
        ...
        <p>
          ...
          <a href={'/cli/login'}>Chalk's command line tool</a>. This guide will walk you through how
