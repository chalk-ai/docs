...
our controls are certified via a SOC-2 Type 2 and ISO/IEC 27001:2022 assessment.
...
tools, including Datadog's [SIEM solution](https://www.datadoghq.com/product/security-platform/cloud-siem/).
...
with the [SANS Incident Handlers Handbook](https://www.sans.org/white-papers/33901/).
