...
} from '@/components/DeploymentArchitectureDiagram'
...
our controls are certified via a SOC-2 Type 1 assessment.
You can request a copy of our certified report by contacting
...
privilege](https://www.google.com/search?q=principle+of+least+privilege&oq=principle+of+least+p&aqs=chrome.0.0i512j69i57j0i512l8.1378j0j7&sourceid=chrome&ie=UTF-8).
