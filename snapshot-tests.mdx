...
- We expect a User's age to change by a maximum amount of 30 days (in reality, average age will increases by precisely the amount of time between invocations of our snapshot test).
