...
between deployments. You can set up snashot testing in Chalk by leveraging Chalk [Datasets](/docs/datasets).
...
to run the action above, you'd get an error when running `client.get_dataset(...)`, which
would indicate that the dataset was not found. To bootstrap your snaphots, you'll
