...
Features can be lists or sets of [scalar](/docs/feature-types#scalars) or [struct](/docs/feature-types#structs) types.
...
[attrs classes](/docs/feature-types#attrs) to represent struct features.
...
Unlike list or set features, are compatible with [embedding functions](/docs/embeddings) and [nearest neighbor similarity search](/docs/nearest-neighbor).
...
class Document:
    ...
    embedding: Vector = embedding(feature="content", provider="openai", model="text-embedding-ada-002")
```
