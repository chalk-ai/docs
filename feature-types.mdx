...
Features can be defined as a JSON type. You can then reference the JSON feature in resolver and query
definitions, and retrieve scalar values from JSON features using
[`chalk.functions.json_value`](https://docs.chalk.ai/api-docs#json_value).
