...
Vector databases can be configured through your Chalk dashboard at **Data Sources > Vector DB**. Once configured, your vector database becomes available for use with [vector search](/docs/vector-search) operations.
