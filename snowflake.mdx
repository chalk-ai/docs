...
and reading it from cloud storage. This is particularly useful for large feature computations. Using 
a storage integration with IAM authentication is the recommended approach as it avoids managing
...
Add the stage reference to your environment variables
