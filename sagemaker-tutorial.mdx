...
can be accomplished by encoding your input features and then using the `F.sagemaker_prediction` underscore
...
@online
def get_encoded_features(amount: _.amount, customer_fico: _.customer.fico, ...) -> Transaction.encoded_features:
