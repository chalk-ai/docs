...
| Writes output data to online store database and offline store database                     | Writes output as a parquet file containing results to cloud storage. Only writes to online or offline store if specified.                 |
