...
- **Required Information**:
  ...
  - **S3 Bucket Name**: Standard naming is `chalk-{organization}-data-bucket`. If this bucket does not exist or uses a different name, contact Chalk for clarification.
  - **Snowflake Role Name**: The role name you defined in the Database Setup step (line 57 above), typically `CHALK_ROLE`
