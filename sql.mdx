...
# This query uses the risk data source c.query(input={User.id: 1}, output=[User.name],
tags=['risk'])
...
# This query uses the default data source c.query(input={User.id: 1}, output=[User.name]) ```
