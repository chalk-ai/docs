...
┃ Kind   ┃ Name                        ┃ Value     ┃
┡━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━┩
│ Expect │ user.transaction_mean__3d__ │    20     │
│ Actual │ user.transaction_mean__3d__ │    21     │
└────────┴─────────────────────────────┴───────────┘
```

Note that since the user's transactions are explicitly passed in as input, there is no need to run any resolvers
that have been defined to compute the transactions for a user.
