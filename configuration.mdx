...
description: Configure your Chalk project and organize your features and resolvers.
published: true
---
            ...
            <SubAttribute field='[environment_name]' kind='dictionary'>
                ...
                <SubAttributeTable title=''>
                    ...
                    <SubAttribute field='requirements' kind='str'>
                        Python requirements file to install with <code>pip</code>. This can either be a <code>requirements.txt</code> file or
                        a <code>pyproject.toml</code> file.
                    </SubAttribute>
                    ...
                    <SubAttribute field='platform_version' kind='str'>
                        ...
                        tag, like <code>v3.0.0</code>, or a release stream like <code>stable</code>. If not specified, defaults to <code>stable</code>.
                    ...
                    <SubAttribute field='metadata' kind='list'>
                        ...
                        <SubAttributeTable title=''>
                            ...
                            <SubAttribute field='missing' kind='"info" | "warning" | "error"'>
                                ...
                                <code>info</code> and <code>warning</code> levels, but disallowed for <code>error</code> level.
                            </SubAttribute>
                        </SubAttributeTable>
                    </SubAttribute>
                </SubAttributeTable>
