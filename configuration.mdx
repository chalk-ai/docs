...
1. `requirements.txt`: Default Python requirements for Chalk to install via `pip` (can be overridden in `chalk.yaml`)
...
Use `chalk.yaml` to configure your project's Docker environment, Python configuration, and feature metadata validation.
    ...
    <SubAttribute field='[environment_name]' kind='dictionary'>
      ...
      <SubAttributeTable title=''>
        ...
        <SubAttribute field='requirements' kind='str'>
          Python requirements file to install with <code>pip</code>.
        </SubAttribute>
...
<Attribute field='validation' kind='dictionary'>
  Configuration for metadata validation for features. See our <a href="/docs/validation#feature-validation-requirements">validation
  documentation</a> for more details.
  <SubAttributeTable title=''>
    <SubAttribute field='[feature_name]' kind='dictionary'>
      The name of the feature.
      <SubAttributeTable title=''>
        <SubAttribute field='metadata' kind='list'>
          A list of dictionaries of metadata attributes and error severity levels when this metadata is missing.
            <SubAttributeTable title=''>
              <SubAttribute field='name' kind='"description" | "owner" | "tags"'>
                The name of the metadata property.
              </SubAttribute>
              <SubAttribute field='missing' kind='"info" | "warning" | "error"'>
                The level of severity to use when a feature is missing this metadata feature. Deploys are permitted for
