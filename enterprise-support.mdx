...
them to get in touch with our support team and file tickets. Finally, the Chalk on-call engineering team
does have a 24/7 paging system and alerting configured for customer environments to ensure that we are able to
respond and mitigate issues in a timely manner. We ask that customers also configure alerting and paging accordingly
...
Customers can create support tickets by starting a new thread and adding the 🎫 ticket reaction. Our team monitors
all tickets and will respond in a timely manner. If you have an urgent issue, please ensure to highlight the urgency
...
that customers can choose to include in their bundles. This allows for a 24/7 line to page our on-call engineer
...
when paging our on-call team so that we can respond as effectively as possible.
...
Enteprise support customers can also page our on-call engeinering team via Slack by adding the 🎫 ticket reaction
