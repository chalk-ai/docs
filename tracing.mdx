...
To use tracing features, please ensure that you add the following Python depdency
- `chalkpy[tracing]`

This links required peer dependencies for OpenTelemetry tracing, including one of `ddtrace` or `opentelemetry-distro`.
